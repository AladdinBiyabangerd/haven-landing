...
export const az: Messages = {
  ...
  journey: {
    ...
    priceForType: {
      prompt: 'Bu tipin tarifi',
      label: 'qiymətlər səhifəsindədir',
    },
    stillLearning: {
      prompt: 'Əvvəl oxumaq istəyirsinizsə,',
      label: 'qısa izaha baxın',
    },
    howItLooks: {
      prompt: 'Heselo-da necə göründüyü',
      label: 'həll səhifəsindədir',
    },
    whichVenue: {
      prompt: 'Hansı məkana aid olduğunu görmək üçün',
      label: 'tipi buradan seçin',
    },
    seePricing: {
      prompt: 'Aylıq tarif',
      label: 'qiymətlər səhifəsindədir',
  ...
  pricing: {
    ...
    capacity: {
      stations: '{n} stansiyaya qədər',
      tables: '{n} masaya qədər',
      rooms: '{n} otağa qədər',
      zones: '{n} zonaya qədər',
    },
    planNames: {
      starter: 'Kiçik',
      plus: 'Orta',
      ...
      gaming: {
        ...
        plans: {
          starter: {
            ...
            desc: 'Telefon qeydi və lövhə əvəzinə cədvəl + canlı sessiya. Günün sonunda kassa bağlanır.',
            features: [
              '{n} PS/PC stansiyasına qədər',
              'Rezerv: cədvəl, köçürmə, ləğv',
              'Canlı sessiya: vaxt, uzatma, ödəniş',
              'Kassa növbəsi və gün bağlanışı',
              'Qəlyanaltı və içki satışı',
            ],
          },
          plus: {
            forWhom: 'Axşam saatları dolu olan klub',
            desc: 'Eyni anda bir neçə sessiya, anbar qalığı və müştəri tarixçəsi — növbə qarışmır.',
            features: [
              '{n} stansiyaya qədər',
              'Eyni anda bir neçə canlı sessiya',
              'Kassa + anbar qalığı',
              'Müştəri kartı və ziyarət tarixçəsi',
              'Növbə sayımı',
            ],
          },
          pro: {
        ...
        plans: {
          starter: {
            ...
            features: [
              ...
              'Canlı sessiya və uzatma',
              'Kassa növbəsi',
              'Qəlyanaltı/içki satışı',
            ],
          },
          plus: {
      ...
      karaoke: {
        ...
        plans: {
          starter: {
            ...
            desc: 'Otaq rezervi mesajlarda itmir. Qonaq gələndə sessiya açılır; əlavə vaxt və içki eyni qeyddə qalır.',
            features: [
              '{n} karaoke otağına qədər',
              'Otaq cədvəli: rezerv, köçürmə, ləğv',
              'Canlı otaq sessiyası',
              'Əlavə vaxt və məhsul eyni qəbzdə',
              'Kassa növbəsi',
            ],
          },
          plus: {
            ...
            features: [
              ...
              'Kassa + anbar qalığı',
              'Müştəri kartı və təkrar gələnlər',
              'Növbə sayımı',
            ],
          },
          pro: {
        ...
        plans: {
          starter: {
            ...
            features: [
              ...
              'Canlı otaq sessiyası',
              'Məhsul eyni qeydə əlavə olunur',
              'Kassa növbəsi',
            ],
          },
          plus: {
    ...
    custom: {
      ...
      features: [
        ...
        'Şərtlər birlikdə təyin olunur',
        'İlkin quraşdırma danışıqla',
      ],
    },
  },
  contact: {
    ...
    venueTypes: [
      { value: 'gaming', label: 'Oyun klubu / PS' },
      { value: 'karaoke', label: 'Karaoke' },
      { value: 'billiards', label: 'Bilyard' },
      { value: 'antikafe', label: 'Antikafe' },
      { value: 'lounge', label: 'Otaqlı launj' },
    ...
    error: 'Göndərmək alınmadı. WhatsApp-dan və ya e-poçtla yazın.',
  ...
  seo: {
    ...
    knowsAbout: [
      ...
      'oyun klubu idarəetmə sistemi',
      'karaoke otaq rezervasiyası',
